...
def process_one(
    ...
    *,
    ...
    temp_dir = ensure_writable_directory(temp_dir or output_dir)
    ...
    with tempfile.TemporaryDirectory(prefix="car-music-", dir=temp_dir) as temporary_dir:
        temporary = Path(temporary_dir) / "encoded.mp3"
